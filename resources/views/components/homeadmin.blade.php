...
<!-- Mirrored from androthemes.com/themes/html/medjestic/ by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 27 Sep 2025 10:31:26 GMT -->
<head>
  ...
  @vite(['resources/vendors/iconic-fonts/font-awesome/css/all.min.css'])
  @vite(['resources/vendors/iconic-fonts/flat-icons/flaticon.css'])
  @vite(['resources/vendors/iconic-fonts/cryptocoins/cryptocoins.css'])
  @vite(['resources/vendors/iconic-fonts/cryptocoins/cryptocoins-colors.css'])
  <!-- Bootstrap core CSS -->
  @vite(['resources/assets2/css/bootstrap.min.css'])
  <!-- jQuery UI -->
  @vite(['resources/assets2/css/jquery-ui.min.css'])
  <!-- Page Specific CSS (Slick Slider.css) -->
  @vite(['resources/assets2/css/slick.css'])
  <!-- medjestic styles -->
  @vite(['resources/assets2/css/style.css'])

  <!-- Page Specific CSS (Morris Charts.css) -->
  @vite(['resources/assets2/css/morris.css'])
  <!-- Favicon -->
...
<body class="ms-body ms-aside-left-open ms-primary-theme ms-has-quickbar">
  ...
  <aside id="ms-side-nav" class="side-nav fixed ms-aside-scrollable ms-aside-left">
    ...
    <div class="logo-sn ms-d-block-lg">
      <a class="pl-0 ml-0 text-center" href="index-2.html"> <img src="{{Vite::asset('resources/assets2/img/medjestic-logo-216x62.png')}}" alt="logo"> </a>
      <a href="#" class="text-center ms-logo-img-link"> <img src="{{Vite::asset('resources/assets2/img/dashboard/doctor-3.jpg')}}" alt="logo"></a>
  ...
  <main class="body-content">
    ...
    <nav class="navbar ms-navbar">
      ...
      <div class="logo-sn logo-sm ms-d-block-sm">
        <a class="pl-0 ml-0 text-center navbar-brand mr-0" href="index-2.html"><img src="{{Vite::asset('resources/assets2/img/medjestic-logo-84x41.png')}}" alt="logo"> </a>
      </div>
      <ul class="ms-nav-list ms-inline mb-0" id="ms-nav-options">
        ...
        <li class="ms-nav-item ms-nav-user dropdown">
          <a href="#" id="userDropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <img class="ms-user-img ms-img-round float-right" src="{{Vite::asset('resources/assets2/img/dashboard/doctor-3.jpg')}}" alt="people"> </a>
        ...
        <div class="col-xl-4 col-md-12">
          ...
          <div class="ms-card ms-widget ms-profile-widget ms-card-fh br-0">
            <div class="ms-card-img">
              <img src="{{Vite::asset('resources/assets2/img/portfolio/gallery-4-760x260.jpg')}}" alt="card_img">
            </div>
            <img src="{{Vite::asset('resources/assets2/img/dashboard/doctor-1.jpg')}}" class="ms-img-large ms-img-round ms-user-img" alt="people">
            ...
            <div class="ms-panel-body p-0 ms-medical-overview-slider">
              <div class="ms-crypto-overview">
                <a href="#" class="ms-profile">
                  <img src="{{Vite::asset('resources/assets2/img/dashboard/doctor-1.jpg')}}" class="ms-img-large ms-img-round ms-user-img mx-auto d-block" alt="people">
                  <div class="ms-card-body">
                    <h5>Anny</h5>
                    <span>Doctor</span>
                  </div>
              ...
              <div class="ms-crypto-overview">
                <a href="#" class="ms-profile">
                  <img src="{{Vite::asset('resources/assets2/img/dashboard/doctor-2.jpg')}}" class="ms-img-large ms-img-round ms-user-img mx-auto d-block" alt="people">
                  <div class="ms-card-body">
                    <h5>Jude</h5>
                    <span>Surgeon</span>
                  </div>
              ...
              <div class="ms-crypto-overview">
                <a href="#" class="ms-profile">
                  <img src="{{Vite::asset('resources/assets2/img/dashboard/doctor-3.jpg')}}" class="ms-img-large ms-img-round ms-user-img mx-auto d-block" alt="people">
                  <div class="ms-card-body">
                    <h5>Jordan</h5>
                    <span>Doctor</span>
                  </div>
              ...
              <div class="ms-crypto-overview">
                <a href="#" class="ms-profile">
                  <img src="{{Vite::asset('resources/assets2/img/dashboard/doctor-4.jpg')}}" class="ms-img-large ms-img-round ms-user-img mx-auto d-block" alt="people">
                  <div class="ms-card-body">
                    <h5>Micheal</h5>
                    <span>Nurse</span>
                  </div>
            ...
            <div class="ms-panel-body">
              <div class="table-responsive">
                <table class="table table-hover thead-primary">
                  ...
                  <tbody>
                    <tr>
                      <td class="ms-table-f-w"> <img src="{{Vite::asset('resources/assets2/img/dashboard/patient-1.jpg')}}" alt="people"> Bernardo Galaviz </td>
                    ...
                    <tr>
                      <td class="ms-table-f-w"> <img src="{{Vite::asset('resources/assets2/img/dashboard/patient-5.jpg')}}" alt="people"> Jenni </td>
                    ...
                    <tr>
                      <td class="ms-table-f-w"> <img src="{{Vite::asset('resources/assets2/img/dashboard/patient-6.jpg')}}" alt="people"> John Doe </td>
                      <td>Dr. Andrew </td>
                      <td>01 Dec 2019</td>
                      <td>10:00 AM</td>
                    ...
                    <tr>
                      <td class="ms-table-f-w"> <img src="{{Vite::asset('resources/assets2/img/dashboard/patient-8.jpg')}}" alt="people"> Alesdro Guitto </td>
                      <td>Dr. Robert </td>
                      <td>01 Dec 2019</td>
                      <td>2:00 PM</td>
                    ...
                    <tr>
                      <td class="ms-table-f-w"> <img src="{{Vite::asset('resources/assets2/img/dashboard/patient-1.jpg')}}" alt="people"> Richard </td>
                      <td>Dr. Adwerd</td>
                      <td>07 Dec 2019</td>
                      <td>5:00 PM</td>
            ...
            <div class="ms-panel-body p-0">
              <ul class="ms-followers ms-list ms-scrollable">
                <li class="ms-list-item media">
                  <img src="{{Vite::asset('resources/assets2/img/dashboard/doctor-1.jpg')}}" class="ms-img-small ms-img-round" alt="people">
                ...
                <li class="ms-list-item media">
                  <img src="{{Vite::asset('resources/assets2/img/dashboard/doctor-2.jpg')}}" class="ms-img-small ms-img-round" alt="people">
                  <div class="media-body mt-1">
                    <h4>Jennifer</h4>
                ...
                <li class="ms-list-item media">
                  <img src="{{Vite::asset('resources/assets2/img/dashboard/doctor-3.jpg')}}" class="ms-img-small ms-img-round" alt="people">
                  <div class="media-body mt-1">
                    <h4>Adwerd </h4>
                ...
                <li class="ms-list-item media">
                  <img src="{{Vite::asset('resources/assets2/img/dashboard/doctor-4.jpg')}}" class="ms-img-small ms-img-round" alt="people">
                  <div class="media-body mt-1">
                    <h4>John Doe</h4>
                ...
                <li class="ms-list-item media">
                  <img src="{{Vite::asset('resources/assets2/img/dashboard/doctor-5.jpg')}}" class="ms-img-small ms-img-round" alt="people">
                  <div class="media-body mt-1">
                    <h4>Jordan</h4>
            ...
            <div class="ms-panel-body">
              <div class="table-responsive">
                <table class="table table-hover  thead-primary">
                  ...
                  <tbody>
                    <tr>
                      <td class="ms-table-f-w"> <img src="{{Vite::asset('resources/assets2/img/dashboard/patient-3.jpg')}}" alt="people"> Richard </td>
                      <td>Richard288@gmail.com</td>
                      <td>+1-202-555-0875</td>
                      <td>Fever</td>
                    </tr>
                    <tr>
                      <td class="ms-table-f-w"> <img src="{{Vite::asset('resources/assets2/img/dashboard/patient-2.jpg')}}" alt="people"> William </td>
                      <td>William434@gmail.com</td>
                      <td>+1-202-534-0112</td>
                      <td>Eye</td>
                    </tr>
                    <tr>
                      <td class="ms-table-f-w"> <img src="{{Vite::asset('resources/assets2/img/dashboard/patient-4.jpg')}}" alt="people"> John Doe </td>
                      <td>johndeo652@gmail.com</td>
                      <td>+1-202-182-0132</td>
                      <td>Typhoid</td>
                    </tr>
                    <tr>
                      <td class="ms-table-f-w"> <img src="{{Vite::asset('resources/assets2/img/dashboard/patient-5.jpg')}}" alt="people"> Martin </td>
                      <td>Martin876@gmail.com</td>
                      <td>+1-202-998-2341</td>
                      <td>Cancer</td>
                    </tr>
                    <tr>
                      <td class="ms-table-f-w"> <img src="{{Vite::asset('resources/assets2/img/dashboard/patient-1.jpg')}}" alt="people"> Robert </td>
  ...
  @vite(['resources/assets2/js/jquery-3.3.1.min.js'])
  @vite(['resources/assets2/js/popper.min.js'])
  @vite(['resources/assets2/js/bootstrap.min.js'])
  @vite(['resources/assets2/js/perfect-scrollbar.js'])
  @vite(['resources/assets2/js/jquery-ui.min.js'])

  <!-- Global Required Scripts End -->
  @vite(['resources/assets2/js/d3.v3.min.js'])
  @vite(['resources/assets2/js/topojson.v1.min.js'])
  @vite(['resources/assets2/js/datamaps.all.min.js'])


  <!-- Page Specific Scripts Start -->
  @vite(['resources/assets2/js/slick.min.js'])
  @vite(['resources/assets2/js/moment.js'])
  @vite(['resources/assets2/js/jquery.webticker.min.js'])
  @vite(['resources/assets2/js/Chart.bundle.min.js'])
  @vite(['resources/assets2/js/index-chart.js'])

  <!-- Page Specific Scripts Finish -->
  @vite(['resources/assets2/js/calendar.js'])
  <!-- medjestic core JavaScript -->
  @vite(['resources/assets2/js/framework.js'])
  <!-- Settings -->
  @vite(['resources/assets2/js/settings.js'])
</body>


<!-- Mirrored from androthemes.com/themes/html/medjestic/ by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 27 Sep 2025 10:33:04 GMT -->
</html>
