...
<body>
                    ...
                    <div class="col-xl-10">
                        <div class="breadcrumb__content">
                            ...
                            <nav class="breadcrumb">
                                ...
                                <span property="itemListElement" typeof="ListItem">Category</span>
                            </nav>
                        </div>
                    </div>
                </div>
    ...
    <div class="form-grp">
        ...
        <input type="text" name="nom" id="nom" class="form-control @error('nom') is-invalid @enderror" value="{{ old('nom', isset($category) ? $category->nom : '') }}" required>
      
    </div>

    <div class="form-grp">
        <label for="description">Description *</label>
        <textarea name="description" id="description" class="form-control @error('description') is-invalid @enderror">{{ old('description', isset($category) ? $category->description : '') }}</textarea>
    ...
    <div class="form-grp">
        ...
        <select name="statut" id="statut" class="form-control @error('statut') is-invalid @enderror" required>
            <option value="disponible" {{ old('statut', isset($category) ? $category->statut : '') == 'disponible' ? 'selected' : '' }}>Disponible</option>
            <option value="non disponible" {{ old('statut', isset($category) ? $category->statut : '') == 'non disponible' ? 'selected' : '' }}>Non disponible</option>
        </select>
    ...
    <div class="form-grp">
        ...
        <input type="datetime-local" name="date_creation" id="date_creation" class="form-control @error('date_creation') is-invalid @enderror" value="{{ old('date_creation', isset($category) ? $category->date_creation->format('Y-m-d\TH:i') : now()->format('Y-m-d\TH:i')) }}" required>
        
    </div>

    <button type="submit" class="tg-btn tg-btn-three black-btn">{{ isset($category) ? 'Modifier' : 'Ajouter' }}</button>
</form>
