...
<body>
    ...
    <div class="form-grp">
        ...
        <select name="statut" id="statut" class="form-control @error('statut') is-invalid @enderror" required>
            ...
            <option value="non disponible" {{ old('statut', $category->statut) == 'non disponible' ? 'selected' : '' }}>Non disponible</option>
        </select>
        @error('statut')
            <div class="invalid-feedback">{{ $message }}</div>
        @enderror
    ...
    <div class="form-grp">
        ...
        <input type="datetime-local" name="date_creation" id="date_creation" class="form-control @error('date_creation') is-invalid @enderror" value="{{ old('date_creation', $category->date_creation->format('Y-m-d\TH:i')) }}" required>
        @error('date_creation')
            <div class="invalid-feedback">{{ $message }}</div>
        @enderror
    </div>
