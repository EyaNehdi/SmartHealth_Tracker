                    ...
                    <div class="col-xl-10">
                        <div class="breadcrumb__content">
                            ...
                            <nav class="breadcrumb">
                                ...
                                <span property="itemListElement" typeof="ListItem">Liste des Catégories</span>
                            </nav>
                        </div>
                    </div>
                </div>
...
<section class="shop__area section-py-150">
    <div class="container">
        ...
        <div class="row">
                        ...
                        @forelse ($categories as $activity)
                            <div class="col-lg-4 col-6">
                                <div class="card">
                                    ...
                                    <a href="#"><img src="{{ Vite::asset('resources/assets/img/images/h3_about_img.jpg') }}" class="card-img-top" alt="{{ $activity->nom }}"></a>
            ...
            <!-- Sidebar avec formulaires de recherche et filtrage -->
            <div class="col-30">
