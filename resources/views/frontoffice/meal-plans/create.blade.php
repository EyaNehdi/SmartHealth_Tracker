...
@section('page-title', 'Créer un Plan de Repas - SmartHealth Tracker')
...
@section('content')
    <main class="main-area fix">
                ...
                <div class="row justify-content-center">
                    <div class="col-xl-10">
                        <div class="breadcrumb__content text-center">
                            <h2 class="title">Créer un Plan de Repas</h2>
        ...
        <!-- meal-plan-create-area -->
        <section class="meal-plan-create-area section-py-150">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-12">
                        <div class="meal-plan-form-container">
                            ...
                            <div class="form-header text-center mb-5">
                                <h3 class="form-title">Créer votre plan de repas</h3>
                                <p class="form-subtitle text-muted">Organisez vos repas sur plusieurs jours</p>
                            </div>

                            <!-- Form -->
                            <form method="POST" action="{{ route('meal-plans.front.store') }}" 
                                    ...
                                    <div class="section-body">
                                        ...
                                        <div class="form-group mt-4">
                                            ...
                                            <textarea id="description" 
                                                      ...
                                                      rows="3" 
                                                      placeholder="Décrivez votre plan de repas, ses objectifs, ses bienfaits...">{{ old('description') }}</textarea>
                                            @error('description')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                ...
                                <div class="form-section">
                                    <div class="section-header">
                                        ...
                                        <p class="section-subtitle">Organisez vos repas par jour et par moment</p>
                                    </div>
...
let mealAssignments = JSON.parse('{!! addslashes(json_encode($oldAssignments)) !!}');
