...
<!-- Mirrored from themeadapt.com/tf/oxinex/login.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 26 Sep 2025 21:11:27 GMT -->
<head>
    <meta charset="utf-8">
    ...
    <main class="main-area fix">
        ...
        <section class="login__area">
            <div class="container-fluid p-0">
                <div class="row gx-0">
                    <div class="col-md-6">
                        <div class="login__left-side" data-background="{{Vite::asset('resources/assets/img/bg/sd_bg.html')}}">
