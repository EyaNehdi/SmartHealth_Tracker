...
<div class="container-fluid">
    ...
    <div class="enhanced-breadcrumb">
        ...
        <div class="d-flex justify-content-between align-items-center">
            <h1 class="h3 mb-0">Add Food Item</h1>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="image-preview-container">
                            <img id="imagePreview"
                                src="{{ asset('assets2/img/food-placeholder.png') }}"
                                alt="Image Preview"
                                class="image-preview">
                        </div>
                    </div>
                                ...
                                <div class="form-group-enhanced">
                                    ...
                                    <div class="input-wrapper">
                                        <select name="serving_type"
                                            ...
                                            <option value="{{ $key }}" {{ old('serving_type') == $key ? 'selected' : '' }}>
                                                {{ $label }}
                                            </option>
                                            @endforeach
                                        </select>
                        ...
                        <div class="form-group-enhanced">
                            ...
                            <div class="input-wrapper">
                                <textarea name="description"
                                    ...
                                    placeholder="Enter detailed description of the food item...">{{ old('description') }}</textarea>
                                @error('description')
                                <div class="error-message">
                                    <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M7 0C3.13 0 0 3.13 0 7C0 10.87 3.13 14 7 14C10.87 14 14 10.87 14 7C14 3.13 10.87 0 7 0ZM7.7 10.5H6.3V9.1H7.7V10.5ZM7.7 7.7H6.3V3.5H7.7V7.7Z" fill="currentColor" />
