        ...
        <div class="col-xl-12 col-md-12">
            <div class="ms-panel">
                ...
                <div class="ms-panel-body">
                    <form class="needs-validation" method="POST" action="{{ route('admin.produits.store') }}" enctype="multipart/form-data" novalidate>
                        @csrf

                        <div class="form-row">
                            <div class="col-md-6 mb-3">
                                <label for="nom">Product Name</label>
                                <input type="text" name="nom" class="form-control @error('nom') is-invalid @enderror" id="nom" placeholder="Enter Product Name" value="{{ old('nom') }}" required>
                                @error('nom')
                        ...
                        <div class="form-row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" step="0.01" name="prix" class="form-control @error('prix') is-invalid @enderror" id="prix" placeholder="Price" value="{{ old('prix') }}" required>
                                @error('prix')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" name="stock" class="form-control @error('stock') is-invalid @enderror" id="stock" placeholder="Stock" value="{{ old('stock') }}" required>
                                @error('stock')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
