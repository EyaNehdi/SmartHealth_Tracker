        ...
        <div class="col-xl-12 col-md-12">
            <div class="ms-panel">
                ...
                <div class="ms-panel-body">
                    <form class="needs-validation" method="POST" action="{{ route('admin.categories.update', $category) }}" novalidate>
                        @csrf
                        @method('PUT')
                        ...
                        <div class="form-row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="nom" class="form-control @error('nom') is-invalid @enderror" id="nom" placeholder="Enter Category Name" value="{{ old('nom', $category->nom) }}" required>
                                @error('nom')
                        ...
                        <div class="form-row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="datetime-local" name="date_creation" class="form-control @error('date_creation') is-invalid @enderror" id="date_creation" value="{{ old('date_creation', $category->date_creation->format('Y-m-d\TH:i')) }}" required>
                                @error('date_creation')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select name="statut" id="statut" class="form-control @error('statut') is-invalid @enderror" required>
                                    <option value="disponible" {{ old('statut', $category->statut) == 'disponible' ? 'selected' : '' }}>Disponible</option>
                                    <option value="indisponible" {{ old('statut', $category->statut) == 'indisponible' ? 'selected' : '' }}>Indisponible</option>
                                </select>
                                @error('statut')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
