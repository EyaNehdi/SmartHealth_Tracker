                    ...
                    <form class="needs-validation" method="POST" action="{{ route('admin.categories.update', $categorie->id) }}" novalidate>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="nom" id="nom" class="form-control @error('nom') is-invalid @enderror" 
                                   placeholder="Entrez le nom de la catégorie (min 2 caractères)" 
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="description" id="description" rows="4" class="form-control @error('description') is-invalid @enderror" 
                                      placeholder="Entrez la description (min 5 caractères)" required>{{ old('description', $categorie->description) }}</textarea>
