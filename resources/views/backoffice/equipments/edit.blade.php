        ...
        <div class="col-xl-12 col-md-12">
            <div class="ms-panel">
                ...
                <div class="ms-panel-body">
                    ...
                    <form class="needs-validation" method="POST" action="{{ route('admin.equipments.update', $equipment->id) }}" id="equipmentForm" novalidate enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="form-row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="nom" class="form-control @error('nom') is-invalid @enderror" id="nom" placeholder="Entrer le nom de l'équipement (lettres, espaces ou tirets)" value="{{ old('nom', $equipment->nom) }}" required>
                                @error('nom')
                        ...
                        <div class="form-row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="marque" class="form-control @error('marque') is-invalid @enderror" id="marque" placeholder="Entrer la marque de l'équipement (lettres, espaces ou tirets)" value="{{ old('marque', $equipment->marque) }}" required>
                                @error('marque')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @else
                                    <div class="invalid-feedback" id="marque-error">La marque doit contenir uniquement des lettres, espaces ou tirets (pas de chiffres ou caractères spéciaux).</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                @if ($equipment->image)
                                    <small>Image actuelle : <a href="{{ asset('storage/' . $equipment->image) }}" target="_blank">Voir</a></small>
                                @endif
                                @error('image')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @else
                        ...
                        <div class="form-row">
                            <div class="col-md-6 mb-3">
                                ...
                                <select name="etat" id="etat" class="form-control @error('etat') is-invalid @enderror" required>
                                    ...
                                    <option value="neuf" {{ old('etat', $equipment->etat) == 'neuf' ? 'selected' : '' }}>Neuf</option>
                                    <option value="bon" {{ old('etat', $equipment->etat) == 'bon' ? 'selected' : '' }}>Bon</option>
                                    <option value="usagé" {{ old('etat', $equipment->etat) == 'usagé' ? 'selected' : '' }}>Usagé</option>
                                    <option value="à réparer" {{ old('etat', $equipment->etat) == 'à réparer' ? 'selected' : '' }}>À réparer</option>
                                </select>
                                @error('etat')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @else
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <textarea name="description" class="form-control @error('description') is-invalid @enderror" id="description" placeholder="Entrer une description" rows="4">{{ old('description', $equipment->description) }}</textarea>
                                @error('description')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @else
